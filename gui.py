...
def gui(parameter_dict):
    ...
    # Add "Backing" header row and the backing row
    ...
    # Add "Back" header row and back layers rows
    ...
    # Add "Piezo" header row and the piezo layer
    ...
    # Add "Front" header row and the front layers
    ...
    # Add "Load" header row and the values row
